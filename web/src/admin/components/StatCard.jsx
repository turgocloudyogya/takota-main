    ...
    <Card className="group relative overflow-hidden p-4 transition-shadow hover:shadow-md">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1.5 text-[1.65rem] leading-none font-bold tracking-tight text-neutral-900 tabular-nums">
            {value}
          </p>
          {hint && <p className="mt-1.5 text-xs text-neutral">{hint}</p>}
        </div>
