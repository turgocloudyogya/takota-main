# AGENTS.md - Takota Contribution Rules
...
Before making any change, read and understand these files:

- **@ARCHITECTURE.md** - System architecture, components, data flows, and deployment.
- **@RULES.md** - Strict rules for AI agents. Non-negotiable. Read before any code change.
- **@CHECKPOINT.md** - Work completion tracking and checkpoint system.
<!-- END:references -->
...
- [ ] Read `@RULES.md` and followed all rules
- [ ] Read `@ARCHITECTURE.md` and understood the system
- [ ] No credentials or secrets in code or documentation
- [ ] All placeholders use `example` or `change-me` values
- [ ] Created checkpoint file in `.checkpoint/` directory
- [ ] All required checks pass (build, lint, vet)
